	...
	for(let i = 0;i<10;i++)
	{
		...
		obj.innerHTML = `
			<div id = "bl${values[i]}header" style = "cursor: move; height: 80px;width:80px;">
		        <img src="/static/main/src/images/ball.png" id = "B${values[i]}" style = "position: absolute;">
...
function makeBucket()
{
	...
	bucket.src = "/static/main/src/images/Inkedbucket.jpg";
...
function chapter2_4()
{
  ...
  var grid = new Image();
  grid.src = "/static/main/src/images/grid.png";
