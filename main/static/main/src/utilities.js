...
function createOptionbox(optionArray, x, y) {
  ...
  op.style.marginLeft = x + "px";
  op.style.marginTop = y + "px";
...
function welcome() {
  ...
  var welcomeBck = new Image();
  welcomeBck.src = "/static/main/src/images/backgroundWelcome.jpeg"

  welcomeBck.onload = function(){
    bck.drawImage(welcomeBck,15,15);
  }
...
function createBook(bookContent) {
  ...
  booktxt.style.backgroundImage = "/static/main/src/images/bookbackground.jpg";
  booktxt.style.fontSize = 25 + "px";
